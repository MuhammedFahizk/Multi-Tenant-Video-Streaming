...
export const authService = {
  ...
  async generateSignedCookies(apiKey, accountTypeId,  tenantDomain, pathPrefix) {
    try {
      const response = await axios.post(`${API_BASE_URL}/business_website/class_room/media/signed_cookies`, {
        accountTypeId,
        pathPrefix,
  ...
  clearCookies(tenantDomain) {
    const cookies = ['CloudFront-Key-Pair-Id', 'CloudFront-Signature', 'CloudFront-Expires'];
